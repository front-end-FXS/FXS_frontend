...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="HeadContent">
    <interestratesheader:Enginy id="interestratesheader" runat="server" Culture="tr-tr"></interestratesheader:Enginy>  
</asp:Content>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">   
    <interestrates:Enginy id="interestrates" runat="server" Culture="tr-tr"></interestrates:Enginy>        
</asp:Content>