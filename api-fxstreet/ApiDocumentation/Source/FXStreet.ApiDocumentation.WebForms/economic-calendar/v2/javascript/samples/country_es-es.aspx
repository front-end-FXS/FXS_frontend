...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="HeadContent">    
    <countryheader:Enginy id="countryheader" runat="server" Culture="es-es"></countryheader:Enginy>
</asp:Content>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
    <country:Enginy id="country" runat="server" Culture="es-es"></country:Enginy>
</asp:Content>