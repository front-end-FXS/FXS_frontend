...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
    <div>        
        <div>
            <h2>
                Market Timeline English full custom
            </h2>
            <p>
        ...
        fxstreet.marketTimeline({
            ...
            markets: {
                sydney: { disabled: false,
                          color: "#FF0000" },  // display sydney market
                london: { disabled: false,
                          color: "#00FF66" },  // display London market in black
                tokyo: { disabled: false,
                         color: "#0011FF" },   // display Tokyo market
                newyork: { disabled: false,
                           color: "#F300FF" }, //display New York market
                abudhabi: { disabled: false,
                            color: "#F3FF00" }, //display Abu Dhabi market
                singapore: { disabled: false,
                             color: "#F99100" }, //display Singapore market
                hongkong: { disabled: false,
                            color: "#00F5F9" } //display Hong Kong market
            },
            background: true, // map background
            holidayColor: "#777777",    // color for holiday
            culture: "en-EN", // diplay culture
            timezone: "US+Eastern+Standard+Time"  // your timezone
        });
        &lt;/script&gt;	
    &lt;/body&gt;
&lt;/html&gt;
